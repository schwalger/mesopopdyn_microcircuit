...
nproc = 1 # number of local threads for NEST simulation (NEST sim with nproc=1 fails if original size network and meanfield_connectivity==False)

#load parameters for potjans column
from potjans import *

#simulation time
t0 = 0.1 #time for relaxation of initial transient
tend = t0 + 0.15
