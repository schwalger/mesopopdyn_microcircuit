...
# make -f Makefile_intensiv all
# based on glm_popdyn_intensiv_no_lokuptbl.c, which is without lookup table; should be similar to multipop15.py, glm_popdyn_1.0.c but as intensiv version
